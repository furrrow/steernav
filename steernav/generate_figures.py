...
def main() -> int:
    ...
    vision_model_name = "microsoft/Florence-2-base-ft"
    ...
    n_pts = 8
    straight_path = np.stack((np.linspace(0, 6, n_pts + 1), np.linspace(0, -1.5, n_pts + 1))).T
    ...
    try:
        while stop_processing is not True:
            ...
            if frame_idx == save_frame_idx:
                image_path = f"frame_{frame_idx:04d}.png"
